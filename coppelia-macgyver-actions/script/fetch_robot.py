...
class Fetch_Robot():
    ...
    def __init__(self, sim=True):
        ...
        print("Instantiating planning scene interface")
    ...
    def addCollisionObject(self, objectname, transfrom_Q, filename, size_scale = .001):
        print("add collision from file: ", filename)
        # print(transfrom_Q, dir(transfrom_Q))
        t,r = transfrom_Q
        print(r, t)
